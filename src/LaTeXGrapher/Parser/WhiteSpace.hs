module LaTeXGrapher.Parser.WhiteSpace
    (
      makeTokenParserWithCustomWhiteSpace
    ) where
...
makeTokenParserWithCustomWhiteSpace :: (Char -> Bool) -> LanguageDef st -> TokenParser st
makeTokenParserWithCustomWhiteSpace isSpace languageDef
